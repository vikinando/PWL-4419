<?Php
//Yuha Aulia Nisa_A11.2020.12647
	...
	<html>
		...
		<body>
			...
			<li class="nav-item">
				...
				<li>
					<a href="manage.php">
					<i class="bi bi-circle"></i><span>Lihat Barang</span>
					</a>
				</li>
				<li>
					<a href="editBrg.php">
			...
			<li class="nav-item">
				...
				<li>
					...
					<i class="bi bi-circle"></i><span>Daftar Bunga</span>
					</a>
				</li>
				<li>
			...
			<main id="main" class="main">
				...
				<nav>
					<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href=cart-remove.php>Kosongkan Cart</a></li>
						...
						<div class="card">
							<div class="card-body">
								...
								if (!empty($_SESSION['cart']["arrCart"])){
									...
									"<br />kembali ke <a href='list-product.php'>List Product</a><br />
									<br />";
									...
									for ($i=0;$i<$max;$i++){
										...
										echo "Total Harga = Rp. ".($_SESSION['cart']["arrCart"][$i]['jml']*$_SESSION['cart']["arrCart"][$i]['hrg']);
										echo "<br />";
										$pembayaran = $pembayaran + ($_SESSION['cart']["arrCart"][$i]['jml']*$_SESSION['cart']["arrCart"][$i]['hrg']);
										$barang = $barang + ($_SESSION['cart']["arrCart"][$i]['jml']);
										echo "<br />";
									}
									
									echo "Total Barang = ".$barang;
									echo "<br />";
									echo "<br />";
			...
			<footer id="footer" class="footer">
				<div class="copyright">
				&copy; Copyright <strong><span>Yuha aulia Nisa</span></strong>. All Rights Reserved
				</div>
				<div class="credits">
