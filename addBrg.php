...
<main id="main" class="main">
	...
	<nav>
		<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="manage.php">Back manage</a></li>
		<li class="breadcrumb-item active"><a href="#">Input Barang</a></li>
		</ol>
	</nav>
	</div><!-- End Page Title -->
					...
					<h5 class="card-title"> Tambah barang</h5>
						...
						<form action='insBrg.php' method='post' enctype="multipart/form-data">
							...
							<div class="form-group">
                                ...
                                <input type="text" class="form-control" name='tjml'>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Deskripsi Barang</label>
                                <textarea class="form-control" rows="5" name='tket'></textarea>
                            </div>
                            <div class="form-group">
